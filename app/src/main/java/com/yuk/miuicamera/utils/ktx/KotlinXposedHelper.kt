...
package com.yuk.miuicamera.utils.ktx
...
fun Any.getFieldByClassOrObject(
    ...
    do {
        clz.declaredFields.filter { !(isStatic && !Modifier.isStatic(it.modifiers)) || !(!isStatic && Modifier.isStatic(it.modifiers)) }.firstOrNull {
